...
ROOT_DOCUMENTS = (
    ...
    "docs/images/inbox-v2-default-preview-528x792.png",
    "docs/images/inbox-v2-open-article-528x792.png",
...
CONTENT_PATTERNS = (
    ...
    ("workspace path", re.compile(r"(?i)[a-z]:[\\/]+[^\\/\r\n]+[\\/]+(?:projects|workspace)[\\/]")),
    ("Codex private path", re.compile(r"(?i)(?:[\\/]|^)\.codex(?:[\\/]|$)")),
    ("private build label", re.compile(r"(?i)\b(?:ready|build)[-_]?[0-9][-_a-z0-9.]*\b")),
