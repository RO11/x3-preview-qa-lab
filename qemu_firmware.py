...
if SIMULATOR_ROOT.name == "x3-simulator" and SIMULATOR_ROOT.parent.name == "tools":
    CROSSPOINT_ROOT = SIMULATOR_ROOT.parents[1]
    WORKSPACE_ROOT = SIMULATOR_ROOT.parents[3]
else:
    CROSSPOINT_ROOT = Path(os.environ.get("X3_CROSSPOINT_ROOT", SIMULATOR_ROOT)).resolve()
    WORKSPACE_ROOT = Path(os.environ.get("X3_WORKSPACE_ROOT", SIMULATOR_ROOT)).resolve()
