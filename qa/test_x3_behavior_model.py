...
class InboxCardsWakeQa(unittest.TestCase):
    ...
    def test_fixed_utc_plus_10_midnight_and_wake_windows(self) -> None:
        before = 2 * 86400 + 13 * 3600 + 59 * 60 + 59
        self.assertEqual(utc_plus_10_local_day(before), 2)
        self.assertEqual(utc_plus_10_local_day(before + 1), 3)
